...
namespace SourceEngine
{
	...
	{
		if (!m_pModelInfo) {
			CreateInterfaceFn factory = GetFactory(GetModuleHandleA(XorStr("engine.dll")));
			m_pModelInfo = CaptureInterface<IVModelInfoClient>(factory, XorStr("VModelInfoClient004"));
		}
		return m_pModelInfo;
	}
}