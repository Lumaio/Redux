...
public:
	...
	bool GetSpotted()
	{
		static bool m_bSpotted = GET_NETVAR(XorStr("DT_BasePlayer"), XorStr("m_bSpotted"));
	...
	CBaseViewModel* GetViewModel() {
		return (CBaseViewModel*)SourceEngine::Interfaces::EntityList()->GetClientEntityFromHandle(*(DWORD*)((DWORD)this + m_hViewModel));
	}
	float* GetMaxAlpha()
	{
