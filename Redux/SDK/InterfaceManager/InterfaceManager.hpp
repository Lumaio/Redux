...
{
	std::wstring wsTmp(moduleName.begin(), moduleName.end());
	auto factory = reinterpret_cast< tCreateInterface >( GetProcAddress( GetModuleHandle( wsTmp.c_str( ) ), "CreateInterface" ) );
	if ( factory )
